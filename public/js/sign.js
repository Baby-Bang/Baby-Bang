            ...
            <form className="form-horizontal">
                ...
                <div className="form-group">
                    <div className="col-md-4 col-md-offset-3">
                        <input type="radio" placeholder="" name="parent" value="woman"/>妈妈
                    </div>
                    <div className="col-md-4">
                        <input type="radio" placeholder="" name="parent" value="man"/>爸爸
                    </div>
                </div>
                <div className="form-group">

                    <button type="button" className="btn btn-default" onClick={this.formSubmit.bind(this)}>注册</button>
                </div>
            </form>
        </div>
    }
